const Mod2_3 = ({ Cuadro, Red, Grey, Esp, Com }) => {
  return (
    <section id="2.3">
      ...
      <h4>CONFIGURATION SECTION:</h4>Esta sección es opcional. Su utilidad es
      documentar el programa COBOL, indicando el modelo de ordenador utilizado y
      asociar los nombres mnemónicos especificados por el programador a nombres
      utilizados por el compilador. Esta sección contiene la descripción del
      ambiente de ejecución del programa COBOL. Incluye información sobre
      configuraciones de hardware y software, como dispositivos de
      entrada/salida, archivos, terminales y otros recursos necesarios para la
      ejecución del programa.
      <ul>
        <li>
          <strong>SOURCE-COMPUTER:</strong> Define el tipo de computadora para
          la cual se está desarrollando el programa COBOL. Esto incluye
          ...
          computadora para la cual se está desarrollando el programa COBOL. La
          opción <u>WITH DEBUGGING MODE</u> permite introducir en el fichero
          fuente COBOL, código que nos servirá de ayuda para depurar el
          programa. Párrafo OBJECT Sirve para especificar el modelo de ordenador
          que va a ejecutar el programa.
          <div className="codigo">
            <Red>SOURCE-COMPUTER</Red>. computer-name.
          </div>
        </li>
        <li>
          <strong>OBJECT-COMPUTER:</strong> Describe la computadora en la que se
        ...
        <li>
          <strong>SPECIAL-NAMES:</strong> Proporciona nombres especiales para
          los caracteres, números o símbolos que se utilizarán en el programa.
          También se utiliza para asignar nombres a los caracteres no
          imprimibles y a los símbolos especiales.
          <ul>
            <li>
              <strong>DECIMAL-POINT IS COMMA:</strong> Esta línea indica que el
            ...
            <li>
              <strong>SYMBOLIC CHARACTER ESPACIO IS 33</strong> ó
              <strong> SYMBOLIC CHARACTER ESCAPE IS 27:</strong> Aquí se define
              un nombre simbólico para un carácter ASCII específico. En este
              caso, se define el carácter con código ASCII 33 (que es el signo
              de exclamación !) y se le asigna el nombre simbólico "ESPACIO".
              Esto puede ser útil para mejorar la legibilidad y mantenibilidad
              del código, ya que permite usar nombres significativos en lugar de
              valores numéricos.
            </li>
            <li>
              <strong>SYMBOLIC CHARACTER MEDIO ARE 172:</strong> Similar al
              ejemplo anterior, aquí se define otro nombre simbólico para un
              carácter ASCII específico. En este caso, se define el carácter con
              código ASCII 172 y se le asigna el nombre simbólico "MEDIO".
            </li>
            <li>
            ...
            <li>
              <strong>NUMERIC:</strong> se utiliza para definir el conjunto de
              caracteres numéricos que se utilizarán en el programa.
            </li>
            <li>
              <strong>CLASS:</strong> Define clases de caracteres para uso en el
            ...
            <li>
            <strong>CURRENCY SIGN</strong>: Define el símbolo que será tratado como signo monetario.
            </li>
            <li>
            <strong>RESERVE NETWORK-PRINTER</strong>: En sistemas mainframe, reserva dispositivos de impresión en red.
            </li>
            <li>
            <strong>CRT STATUS IS</strong>: Para interfaces de pantalla (usado en COBOL con control de terminales).
            </li>
            <li>
            <strong>XML-SCHEMA</strong>: Define el esquema XML cuando se usa soporte XML en COBOL (más común en compiladores modernos).
            </li>
            <li>
            <strong>ENVIRONMENT-NAME</strong>: Define nombres simbólicos para variables de entorno del sistema operativo.
            </li>
          </ul>
          <div className="codigo">
            ...
            <Esp />
            <Red>NUMERIC IS NUMEROS_DOLARES IS </Red>{" "}
            <Grey>"0123456789.$"</Grey>. <br />
            <Esp />
            <Red>CLASS IS LETRAS IS UPPER-LETTERS LOWER-LETTERS</Red>. <br/>
            <Esp />
            <Red>CURRENCY SIGN IS</Red> <Grey>"€"</Grey>. <br/>
            <Esp />
            <Red>RESERVE</Red> NETWORK-PRINTER <Red>FOR PRINTING</Red>.<br/>
            <Esp />
            <Red>CRT STATUS IS</Red> ESTADO-TECLA.<br/>
            <Esp />
            <Red>XML-SCHEMA</Red> <Grey>"clientes.xsd"</Grey>.<br/>
            <Esp />
            <Red>ENVIRONMENT-NAME</Red> PATH-NOMBRE <Red>IS</Red> <Grey>"PATH"</Grey>.<br/>
          </div>
        </li>
      </ul>
      <h4>INPUT-OUTPUT SECTION:</h4> Esta sección es opcional.Describe los archivos
      ...
      archivos relativos, así como los dispositivos de entrada/salida y otros
      recursos relacionados con la entrada y salida de datos.Uso obligatorio si
      se utilizan archivos externos.
     
      <ul>
        <li>
          <strong>FILE-CONTROL:</strong> Proporciona información detallada sobre
          los archivos utilizados por el programa, como nombres de archivos,
          organización, tipo de acceso y otras características necesarias para
          el manejo de archivos.
          <ul>
            <li>
              <strong>SELECT:</strong> Especifica el nombre lógico del archivo y
            ...
            <li>
              <strong>ORGANIZATION:</strong> Indica la organización del archivo
              en el sistema de archivos, como secuencial, secuencial indexado o
              relativo. Puede ser:
              <ul>
                <li>
                ...
                <li>
                  ...
                  registros se almacenan en ubicaciones relativas a un número
                  base. Se puede acceder a registros específicos utilizando un
                  número relativo, que indica la posición del registro en
                  relación con el número base. Los registros no necesariamente
                  se almacenan en orden secuencial en el archivo; pueden estar
                  dispersos. Es útil cuando se necesitan accesos aleatorios a
                  registros específicos en el archivo, pero no se requiere una
                  clave de acceso primaria.
                </li>
                <li>
                  <strong>INDEXED:</strong>En un archivo indexado, los registros
                  se organizan en orden secuencial en el archivo principal, pero
            ...
            <li>
              <strong>ACCESS MODE:</strong> Define el modo de acceso al archivo,
              en COBOL se utiliza para especificar cómo se accederá al archivo
            ...
            <li>
              <strong>FILE STATUS:</strong> Opcional. Define una variable que
            ...
            <li>
              <strong>PASSWORD:</strong> Opcional. Proporciona una contraseña de
            ...
            <li>
              <strong>RECORDING MODE:</strong> Esta declaración se utiliza para
            ...
            <li>
              <strong>I-O-CONTROL: </strong>Especifica las características de
              los dispositivos de entrada y salida. Se utiliza para proporcionar
              control adicional sobre la entrada y salida (E/S) de archivos en
              el programa
              <ul>
                <li>
                  RERUN: Esta cláusula indica que se pueden volver a ejecutar
                  registros previamente procesados de un archivo secuencial
                  después de haberse llegado al final del archivo.
                </li>
                <li>
                  MERGE: Esta cláusula se utiliza para especificar que el
                  archivo de salida será un archivo de combinación. Es decir,
                  los registros de entrada se combinan o se fusionan en un solo
                  archivo de salida.
                </li>
                <li>
                ...
                <li>
                  MULTIPLE FILE THREADING: Esta cláusula permite la activación
                  de subprocesos múltiples para realizar E/S en archivos.
                </li>
                <li>
                  BLOCK CONTAINS n RECORDS: Se utiliza para especificar el
                  tamaño del bloque de registros en E/S secuencial. El valor n
                  representa la cantidad de registros que se leerán o escribirán
                  en cada operación de E/S.
                </li>
                <li>
                  CONCURRENT ACCESS: Permite el acceso simultáneo a un archivo
            ...
            <li>
              ...
              archivo.se utiliza para asociar un archivo lógico definido en el
              programa con un archivo físico en el sistema de archivos. El uso
              de ASSIGN es fundamental para establecer la conexión entre el
              programa COBOL y los archivos que utiliza. Al especificar la
              asignación entre el archivo lógico y el archivo físico, el
              programa sabe a qué archivo debe acceder durante la ejecución para
              leer o escribir datos.
            </li>
            <li>
              <strong>RECORD FORMAT: </strong>Especifica el formato de los
              registros del archivo. Se utiliza para especificar el formato de
              ...
              <ul>
                <li>
                  ...
                  caracteres o bytes, independientemente de la cantidad de datos
                  que contenga. Se utiliza cuando los registros tienen una
                  longitud predefinida y uniforme.
                </li>
                <li>
                  ...
                  diferente, dependiendo de la cantidad de datos que contenga.
                  Es útil cuando los registros pueden tener longitudes variables
                  y se desea minimizar el espacio desperdiciado en el archivo.
                </li>
              </ul>
            </li>
            <li>
              <strong>ALTERNATE RECORD KEY IS: </strong> se utiliza para
              especificar campos alternativos que sirven como claves de acceso
              en archivos indexados. En los archivos indexados, además de la
              clave de acceso principal definida mediante RECORD KEY IS, se
              pueden especificar una o más claves de acceso alternativas
              utilizando ALTERNATE RECORD KEY IS. Estas claves de acceso
              alternativas proporcionan métodos adicionales para acceder a los
              registros del archivo de manera eficiente, lo que puede ser útil
              en diversas situaciones de acceso a datos.
            </li>
          </ul>
        </li>
      </ul>
      ...
      <div className="codigo">
        ...
        <Esp />
        <Red>CONFIGURATION SECTION</Red>. <br />
        <Esp />
        <Esp />
        <Red>SOURCE-COMPUTER</Red>. IBM-Z-SERIES. <br />
        <Esp />
        <Esp />
        <Red>OBJECT-COMPUTER</Red>. IBM-Z-SERIES. <br />
        <Esp />
        <Esp />
        <Red>SPECIAL-NAMES</Red>. <br />
        <Esp />
        ...
        <Esp />
        <Esp />
        <Red>SELECT</Red> ARCHIVO1 <Red>ASSIGN TO</Red> <Grey>"DATOS.TXT"</Grey>{" "}
        <br />
        <Esp />
        <Esp />
        <Esp />
        ...
        <Esp />
        <Esp />
        <Red>FILE STATUS IS ESTADO-ARCHIVO</Red>. <br />
        <Esp />
        <Esp />
        <Red>I-O-CONTROL</Red>. <br />
        <Esp />
        <Esp />
        <Esp />
        <Red>APPLY WRITE-ONLY ON</Red> ARCHIVO1. <br />
      </div>
    </section>
  );
};
